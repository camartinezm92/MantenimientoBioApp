          ...
          <div className="border-r-2 border-b-2 border-[#003366] p-2 text-black font-semibold">
            {isViewOnly ? formData.equipment : (
              ...
              >
                ...
                <option value="COMPRESOR ODONTOLÓGICO">COMPRESOR ODONTOLÓGICO</option>
                <option value="CONGELADOR">CONGELADOR</option>
                <option value="DESFIBRILADOR">DESFIBRILADOR</option>
                <option value="DESTILADOR DE AGUA">DESTILADOR DE AGUA</option>
                <option value="DIGITALIZADOR">DIGITALIZADOR</option>
                <option value="DINAMÓMETRO ">DINAMÓMETRO </option>
                ...
                <option value="INYECTOR DE CONTRASTE">INYECTOR DE CONTRASTE</option>
                ...
                <option value="MARTILLO DE REFLEJOS">MARTILLO DE REFLEJOS</option>
                ...
                <option value="PIEZA DE ALTA VELOCIDAD">PIEZA DE ALTA VELOCIDAD</option>
                <option value="PIEZA DE MANO DE BAJA ">PIEZA DE MANO DE BAJA </option>
                <option value="PIPETAS AUTOMÁTICAS">PIPETAS AUTOMÁTICAS</option>
                <option value="REFRIGERADORES">REFRIGERADORES</option>
                <option value="REGULADOR DE VACIO">REGULADOR DE VACIO</option>
                <option value="SELLADORA MANUAL">SELLADORA MANUAL</option>
                ...
                <option value="UNIDAD ODONTOLOGICA">UNIDAD ODONTOLOGICA</option>
                <option value="USUCCIONADOR QX">SUCCIONADOR QX</option>
          ...
          <div className="col-span-4 border-r-2 border-b-2 border-[#003366] p-2 text-black font-semibold">
            {isViewOnly ? formData.invima : (
              ...
              >
                    ...
                    <option value="INVIMA 2023DM-0026394">COLCHONES ANTIESCARAS</option>
                    <option value="NO PRESENTA">COMPRESOR ODONTOLÓGICO</option>
                    <option value="NO PRESENTA">CONGELADOR</option>
                    <option value="INVIMA 2019EBC-0004075-R1 ">DESFIBRILADOR</option>
                    <option value="NO PRESENTA">DESTILADOR DE AGUA</option>
                    <option value="INVIMA 2024DM-0011472-R1">DIGITALIZADOR</option>
                    <option value="NO PRESENTA">DINAMÓMETRO </option>
                    <option value="INVIMA 2015EBC-0014074">ELECTROBISTURÍ</option>
                    <option value="INVIMA 2018DM-0003378-R1 - 2008DM-0001919">ELECTROCARDIÓGRAFO</option>
                    <option value="INVIMA 2022DM-0025363">ELECTROENCEFALÓGRAFO</option>
                    <option value="INVIMA 2009DM-0003901">EQUIPO DE HEMATOLOGÍA</option>
                    <option value="INVIMA 2022DM-0009186-R1 - INVIMA 2017DM-0017337">EQUIPO DE ÓRGANOS</option>
                    <option value="INVIMA 2012DM-0008807">EQUIPO DE QUÍMICA</option>
                    <option value="INVIMA2019EBC-0002444-R1">EQUIPO DE RAYOS X PORTÁTIL</option>
                    <option value="INVIMA 2011DM-0008086">ESTERILIZADOR</option>
                    <option value="INVIMA 2008DM-0001523 - INVIMA 2009DM-0003227 - INVIMA 2009DM-0005053">FLUJÓMETROS</option>
                    <option value="INVIMA 2019DM-0020015 -  INVIMA 2020DM-0022263">FONENDOSCOPIOS</option>
                    <option value="INVIMA 2014DM-0012094">GLUCÓMETROS</option>
                    <option value="INVIMA 2022DM-0025198">INCUBADORA</option>
                    <option value="INVIMA 2017EBC-0000539-R1">INYECTOR DE CONTRASTE</option>
                    <option value="INVIMA 2013DM-0010460 ">LÁMPARA CIELÍTICA</option>
                    <option value="NO PRESENTA">LÁMPARA DE BANCO DE SANGRE</option>
                    <option value="INVIMA 2018DM-0018133">LARINGOSCOPIO</option>
                    <option value="INVIMA2020EBC-0003730-R1">MÁQUINA DE ANESTESIA</option>
                    <option value="INVIMA 2019DM-0019298">MÁQUINA DE GASES</option>
                    <option value=" INVIMA 2019DM-0019852">MARTILLO DE REFLEJOS</option>
                    <option value="INVIMA 2015DM-0012529">MESA DE CIRUGÍA</option>
                    <option value="NO PRESENTA">MICROSCOPIO</option>
                    <option value="INVIMA 2016EBC-0014448">MONITOR DE SIGNOS VITALES</option>
                    <option value="INVIMA 2016DM-0015191">PIEZA DE ALTA VELOCIDAD</option>
                    <option value="INVIMA 2015DM-0013299">PIEZA DE MANO DE BAJA </option>
                    <option value="NO PRESENTA">PIPETAS AUTOMÁTICAS</option>
                    <option value="NO PRESENTA">REFRIGERADORES</option>
                    <option value="INVIMA 2014DM-0012110">REGULADOR DE VACIO</option>
                    <option value="NO APLICA">SELLADORA MANUAL</option>
                    <option value="INVIMA 2017DM-0017305">SILLAS DE RUEDAS</option>
                    <option value="INVIMA 2010DM-0006598">SUCCIONADORES</option>
                    <option value="INVIMA 2008EBC-0001540">TAC</option>
                    <option value="NO PRESENTA">TALLÍMETRO</option>
                    <option value="INVIMA 2018DM-0018127">TENSIÓMETRO</option>
                    <option value="NO PRESENTA">TERMOHIGRÓMETROS</option>
                    <option value="INVIMA 2018DM-0002616-R1">TERMÓMETRO DIGITAL</option>
                    <option value="NO PRESENTA">UNIDAD ODONTOLOGICA</option>
                    <option value="INVIMA 2014DM-0011987">SUCCIONADOR QX</option>
                    <option value="2008EBC-0001832 - 2022EBC-0009226-R1 - EXCEPCIÓN">VENTILADOR MECÁNICO</option>
                </select>
          ...
          <div className="col-span-10 p-2 text-black font-semibold">
            {isViewOnly ? formData.location : (
              ...
              >
                ...
                <option value="PRETRANSFUSIONAL">PRETRANSFUSIONAL</option>
